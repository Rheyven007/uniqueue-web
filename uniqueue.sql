...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2026 at 02:06 PM
...
(1, 'Certificate of Good Moral', 1, 0, 5, '2026-06-30 07:02:40'),
(2, 'Copy of all Grades', 1, 0, 5, '2026-06-30 07:03:06');
...
(1, 1, 'Birth Certificate', '2026-06-30 07:02:40'),
(2, 1, 'Student ID', '2026-06-30 07:02:40'),
(3, 2, 'Student ID', '2026-06-30 07:03:06');
...
(1, 1, 1, 1, 'Q-0001', 'walkin', 'waiting', 1, 'pwd', '2026-07-01', NULL, NULL, '2026-07-01 20:02:30', NULL, NULL, '2026-07-01 12:02:30', '2026-07-01 12:02:30');
...
--
-- Dumping data for table `queue_ticket_document`
--

INSERT INTO `queue_ticket_document` (`id`, `ticket_id`, `document_id`, `quantity`) VALUES
(1, 1, 1, 1),
(2, 1, 1, 1);
...
(4, 'Erich', 'Castillo', '23-71162', NULL, 1, NULL, '$2y$10$uiImyk19q8TRl4OrX84cGeF6YxCo9K8sSePXZNDhJ1R6du.MyvOAq', '2026-06-24 14:28:19', '2026-06-24 14:28:19'),
(5, 'Eiah', 'Cruz', '23-12345', 4, 16, NULL, '$2y$10$jUAYVbxYcxu4GwwlKAVp.eZc42zraco/iwhkMy/VRwrQhozEWEsde', '2026-06-28 06:04:45', '2026-06-28 06:04:45');
...
CREATE TABLE `windows` (
  ...
  `queue_type` enum('walkin','appointment','both') NOT NULL DEFAULT 'both',
  `appointment_date` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `windows` (`id`, `name`, `office_id`, `status`, `speed`, `queue_type`, `appointment_date`) VALUES
(1, 'Window 1', 1, 'open', 'normal', 'both', '2026-07-02'),
(2, 'Window 2', 1, 'open', 'normal', 'walkin', NULL),
(3, 'Window 3', 1, 'open', 'normal', 'both', '2026-07-01');
